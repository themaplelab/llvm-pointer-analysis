...
template<class T> using B = typename A<T>::U; // expected-error {{no type named 'U' in 'A<short>'}} expected-note {{in instantiation of template class 'A<short>' requested here}}
template<class T> struct A {
